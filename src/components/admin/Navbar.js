...
//     { label: 'Banner Text', icon: <Settings />, value: 'settings' ,route:"/admin-bannertext"},
//   ];
...
//         }}>
//           {navItems.map((item) => (
//          <Link      key={item.value} href={item.route}>
//             <NavButton
...
//               anchorOrigin={{ horizontal: 'right', vertical: 'bottom' }}
//             >
//               <MenuItem onClick={handleMenuClose}><Avatar /> Profile</MenuItem>
//               <Divider />
...
//           <List>
//             {navItems.map(item => (
//               <Link key={item.value} href={item.route} style={{ textDecoration: 'none', color: 'inherit' }}>
//                 <ListItem button onClick={() => handleTabChange(item.value)}>
